...
class QuickBooks_Utilities
{
	...
	static public function priorityForAction($action, $dependency = null)
	{
		...
		static $priorities = array(
            ...
            QUICKBOOKS_QUERY_INVENTORYSITE,
            QUICKBOOKS_QUERY_ITEMSITES,
            ...
            QUICKBOOKS_IMPORT_INVENTORYSITE,
            QUICKBOOKS_IMPORT_ITEMSITES,
    ...
    public static function prettyXmlString($xml){
        $xml = preg_replace('/(>)(<)(\/*)/', "$1\n$2$3", $xml);
        $token      = strtok($xml, "\n");
        $result     = '';
        $pad        = 0;
