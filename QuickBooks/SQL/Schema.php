...
class QuickBooks_SQL_Schema
{
	...
	static public function mapPrimaryKey($path_or_tablefield, $mode, &$map, $options = array())
	{
		static $xml_to_sql = array(
            ...
            'CustomerRet ShipToAddress' => 																array( 'Customer_ShipToAddress', array( 'Customer_ListID', 'Name' ) ),
            ...
            'ItemSitesRet' => 																		    array( 'ItemSites', 'ListID' ),
...
//            'DataExtRet' => 															                array( 'DataExt', array( 'EntityType', 'TxnType', 'Entity_ListID', 'Txn_TxnID' ) ),
	...
	static public function mapToSchema($path_or_tablefield, $mode, &$map, &$others, $options = array())
	{
		static $xml_to_sql = array(
            ...
            'CustomerRet ShipToAddress' => 				array( 'Customer_ShipToAddress', null ),
            'CustomerRet ShipToAddress *' => 				array( 'Customer_ShipToAddress', '*' ),
...
//            'DataExtRet *' => 					array( 'DataExt', '*' ),
            ...
            'ItemSitesRet' => 											    array( 'ItemSites', null ),
            'ItemSitesRet ItemInventoryAssemblyRef' => 						array( null, null ),
            'ItemSitesRet ItemInventoryAssemblyRef *' => 					array( 'ItemSites', 'ItemInventoryAssembly_*' ),
            'ItemSitesRet ItemInventoryRef' => 						        array( null, null ),
            'ItemSitesRet ItemInventoryRef *' => 						    array( 'ItemSites', 'ItemInventory_*' ),
            'ItemSitesRet InventorySiteRef' => 							    array( null, null ),
            'ItemSitesRet InventorySiteRef *' => 							array( 'ItemSites', 'InventorySite_*' ),
            'ItemSitesRet InventorySiteLocationRef' => 						array( null, null ),
            'ItemSitesRet InventorySiteLocationRef *' => 				    array( 'ItemSites', 'InventorySiteLocation_*' ),

            'ItemSitesRet *' => 											    array( 'ItemSites', '*' ),
